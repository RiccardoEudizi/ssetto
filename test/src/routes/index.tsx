...
export default function Home() {
  ...
  return (
    <main class="text-center  flex flex-col justify-center items-center  h-screen  text-black p-4 antialiased">
      ...
      <div class="max-w-5xl">
      <Drawer.Root side="bottom"  bgSelector={document.querySelector("#app") as HTMLElement}>
      <div class="p-4 ">
        <h1 class="font-semibold text-7xl leading-relaxed  ">Ssetto</h1>
        <div class="flex gap-x-12 mt-8">
        <Drawer.Trigger  class="rounded-xl bg-stone-50 border border-stone-300 shadow-sm border-opacity-75  px-4 w-fit self-center py-3 text-lg font-medium text-stone-600 transition-all duration-100 hover:bg-stone-200 active:translate-y-0.5">
          Open Drawer
        </Drawer.Trigger>
        ...
        <Drawer.Portal>
          <Drawer.Overlay />
          <Drawer.Content class="max-h-[90vh]  -bottom-5 w-full  rounded-b-lg bg-stone-50 ">
